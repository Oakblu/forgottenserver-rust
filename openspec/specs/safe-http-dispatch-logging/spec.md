...
The Docker Compose configuration for the HTTP login server port SHALL bind to `127.0.0.1` only, not to `0.0.0.0`.

### Scenario: Port is not reachable from outside the host
